  ...
  onLoad: function() {
    ...
    wx.getStorage({
      ...
      success: function(res) {
        ...
        let _url = 'https://foodninja.cloudxink.com/api/v1/yuedans?api_token=' + res.data + ''
        wx.request({
          url: _url,
          data: {
            api_token: res.data
        ...
        let _urlMore = 'https://foodninja.cloudxink.com/api/v1/yuedan/more?api_token=' + res.data + ''
        wx.request({
          url: _urlMore,
          data: {
            api_token: res.data
